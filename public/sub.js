...
/******/ 	deferredModules.push(["./src/js/app.js","utils","vendors"]);
...
const init = async () => {
  ...
  await asyncFn();
  jQuery();
  _utils__WEBPACK_IMPORTED_MODULE_3__["default"].log('hello form app.js');
};
...
/* WEBPACK VAR INJECTION */(function(jQuery, utils) {// import jQuery from "jquery";
console.log('this is a main js file.');
jQuery();
